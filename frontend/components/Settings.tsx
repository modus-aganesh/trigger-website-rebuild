...
export const SettingsComponent = ({
  ...
  return (
    ...
    >
      ...
      <SwitchSynced
        globalConfigKey="autoRebuild"
        disabled={disabled}
        label="Automatically rebuild site"
      />

      <Accordion
        value={getAccordion("table-options", true)}
        onChange={handleAccordion("table-options", true)}
        title="Table options"
        description="Change these settings to change which tables are listened on."
      >
        <FormField
          label="Tables to ignore"
          description="A comma separated list of tables to ignore"
        >
          <InputSynced
            globalConfigKey="tableIgnore"
            type="text"
            disabled={disabled}
            placeholder=""
          />
      ...
      <Accordion
        value={getAccordion("webhook", false)}
        onChange={handleAccordion("webhook", false)}
